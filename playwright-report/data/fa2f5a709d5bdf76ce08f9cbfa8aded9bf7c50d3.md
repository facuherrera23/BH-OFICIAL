...
- Name: supervision.e2e.spec.ts >> Centro de Supervisión - Auditoría de Eventos >> audit_event_created_after_lead_update
- Location: tests\supervision.e2e.spec.ts:73:7
