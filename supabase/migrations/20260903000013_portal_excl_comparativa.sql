-- ============================================================
-- 20260903000013_portal_excl_comparativa
-- Agrega a portal_get_portal_data la comparativa del período
-- anterior de igual duración a la exclusividad, para que el
-- portal pueda mostrar si el rendimiento sube/baja.
