...
- Name: supervision.e2e.spec.ts >> Centro de Supervisión - Auditoría de Eventos >> audit_event_created_after_visit_update
- Location: tests\supervision.e2e.spec.ts:106:7
