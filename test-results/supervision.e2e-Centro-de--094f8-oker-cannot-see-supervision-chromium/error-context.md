...
- Name: supervision.e2e.spec.ts >> Centro de Supervisión - Control de Acceso >> broker_cannot_see_supervision
- Location: tests\supervision.e2e.spec.ts:15:7
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e7]:
      - generic [ref=e8]:
        ...
        - generic [ref=e10]:
          - generic: 
          - textbox "admin@bienenhaus.com.ar" [ref=e11]: broker@test.com
      - generic [ref=e12]:
