...
- Name: supervision.e2e.spec.ts >> Centro de Supervisión - Auditoría de Eventos >> audit_event_created_after_property_update
- Location: tests\supervision.e2e.spec.ts:33:7
