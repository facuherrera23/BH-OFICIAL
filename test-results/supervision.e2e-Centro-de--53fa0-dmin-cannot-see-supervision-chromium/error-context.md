...
- Name: supervision.e2e.spec.ts >> Centro de Supervisión - Control de Acceso >> admin_cannot_see_supervision
- Location: tests\supervision.e2e.spec.ts:10:7
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e7]:
      - generic [ref=e8]:
        ...
        - generic [ref=e10]:
          - generic: 
          - textbox "admin@bienenhaus.com.ar" [ref=e11]: admin@test.com
      - generic [ref=e12]:
